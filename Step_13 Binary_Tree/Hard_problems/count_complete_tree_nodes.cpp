...
public:
    ...
    // Function to count nodes
    // in a binary tree
    int countNodes(TreeNode* root) {           //Time Complexity: O(log N * log N) where N is the number of nodes in the Binary Tree.
